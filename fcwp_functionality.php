...
if( !class_exists( 'FCWP_Custome_Functionality' ) ) {
	class FCWP_Custome_Functionality {
		...
		private function includes() {
			...
			require_once FCWP_PL_PLUGIN_DIR . 'admin/classes/class-fcwp-remove-customizer.php';
			...
			require_once FCWP_PL_PLUGIN_DIR . 'includes/classes/class-fcwp-list-terms.php';
			...
			require_once FCWP_PL_PLUGIN_DIR . 'includes/classes/class-fcwp-stop-attachment-comments.php';
			...
			//require_once FCWP_PL_PLUGIN_DIR . 'includes/classes/class-fcwp-widget.php';
			//require_once FCWP_PL_PLUGIN_DIR . 'includes/classes/class-fcwp-register-post-type.php';
			//require_once FCWP_PL_PLUGIN_DIR . 'includes/classes/class-fcwp-register-taxonomies.php';
			require_once FCWP_PL_PLUGIN_DIR . 'includes/template-functions.php';
